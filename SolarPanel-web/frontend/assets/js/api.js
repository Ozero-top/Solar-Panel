...
const APP_CHANGELOG = [
  {
    ver: 'v1.0.003', date: '2026-09-08',
    items: [
      '后台「站点设置」合并分区：原「🕐 时钟与天气」分区并入「🧭 基础信息」，显示时钟、天气显示、天气城市与站点标题/公告等基础配置统一在「基础信息」分区保存，减少二级导航切换。',
    ],
  },
  {
    ver: 'v1.0.002', date: '2026-09-08',
    items: [
      '后台「站点设置」合并分区：原「🖼️ Logo 与壁纸」分区并入「🎨 外观布局」，Logo、壁纸、遮罩透明度、壁纸模糊与主题/布局/卡片配置统一在「外观布局」分区保存，减少二级导航切换。',
      '修复在线升级校验：放宽 manifest 版本号正则，兼容 v1.0.001 三段式与 v0.10.0.0022 四段式版本号（v1.0.001 站点需先手动替换一次 backend/lib/upgrade.php 才能在线升级到本版）。',
    ],
  },
  {
    ver: 'v1.0.001', date: '2026-09-07',
    items: [
...
const SP_STYLES = ['soft', 'nature', 'natural', 'holo', 'gradient', 'material', 'fabric', 'aurora', 'scandi', 'clay', 'spotlight', 'neumorphism', 'skeuomorphism', 'immersive-photo', 'ghibli', 'fluent'];
